# SmartThings Brave Release Process
...
1. **Alert others you are releasing**
   ...
   a release, alert others on slack so that they don't accidentally merge
...
1. **Wait for CircleCI**
   ...
   the version, publishes artifacts, and syncs to Maven Central. https://circleci.com/gh/smartthingsoss/brave

## Credentials

Credentials of various kind are needed for the release process to work. If you notice something
failing due to unauthorized, re-save them as [environment variables](https://circleci.com/gh/smartthingsoss/brave/edit#env-vars).
